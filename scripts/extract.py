...
nif_folder = '/Users/farismustafa/Documents/Projects/daoc/spellcraft/client/scripts/Dark Age of Camelot'
...
re_nif = re.compile(r'^.*\.(nif|dds|tga|kf|kfa)$', re.IGNORECASE)
